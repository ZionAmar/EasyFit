...
const { checkLoginRateLimit, isLoggedIn, requireRole, checkResetRateLimit } = require('../middlewares/auth_Midd');
...
router.post('/forgot-password', checkResetRateLimit, authController.requestPasswordReset);
